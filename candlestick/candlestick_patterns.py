...
def rain_drop(candles_df, ohlc=__default_ohlc, is_reversed=False, target=None):
    cndl = __create_object('RainDrop', target)
    return cndl.has_pattern(candles_df, ohlc, is_reversed)

def rain_drop_doji(candles_df, ohlc=__default_ohlc, is_reversed=False, target=None):
...
def evening_star_doji(candles_df, ohlc=__default_ohlc, is_reversed=False, target=None):
    cndl = __create_object('EveningStarDoji', target)
    return cndl.has_pattern(candles_df, ohlc, is_reversed)

def tweezer_top(candles_df, ohlc=__default_ohlc, is_reversed=False, target=None):
    cndl = __create_object('TweezerTop', target)
    return cndl.has_pattern(candles_df, ohlc, is_reversed)

def tweezer_bottom(candles_df, ohlc=__default_ohlc, is_reversed=False, target=None):
    cndl = __create_object('TweezerBottom', target)
    return cndl.has_pattern(candles_df, ohlc, is_reversed)